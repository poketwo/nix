    ...
    netdevs."99-wg0" = {
      ...
      wireguardPeers =
        ...
        [
          ...
          (makePeer "3dN6v6LGpGYkka1mRW0XiZNPyNxvGXEDRM7N2H6vPFY=" [ "10.0.1.8/32" ])
          (makePeer "V2Ftux68Fm87u70wQ92V0rGNRprPKdqf56khMii/hHU=" [ "10.0.1.9/32" ])
          (makePeer "2lgbJAcNghipThAacQUX+GaKJ0F3zvZLXiIV7iZWWhM=" [ "10.0.1.10/32" ])
          (makePeer "xdo0B3RLN2gPOb1LoDnzQofUkPzaNpifmGfoVPY8eks=" [ "10.0.1.11/32" ])
          (makePeer "Hn3lhneJQiv9KHPJp2KIY1O783EY0Nl0sNzu4YK4fSY=" [ "10.0.1.12/32" ])
          (makePeer "21QfQXFUXUcYFmwwXHF/Clg2+/8ohmh0ozYTQkNsNQc=" [ "10.0.1.13/32" ])
          (makePeer "2SNBdiLynHBiz5S1J70aWp2bJeCBwR36Xw5yD386Gmc=" [ "10.0.1.14/32" ])
          (makePeer "KKxE9JKRGJ+5Jj4Ym1NFgt+JO9kHeX9Bd0hWCakVMEA=" [ "10.0.1.15/32" ])
          (makePeer "+EiEzK4On5BrNkcP1IcGNeToXudRpDhEl5lJm1stn2M=" [ "10.0.1.16/32" ])
          (makePeer "+Yq61rAePR5LnNz7rN1IKf2EMACm6lawUngoopN4lgs=" [ "10.0.1.17/32" ])
          (makePeer "SN7GxfbGWuubPS+GPnnGjBVeYFgfVR1iqfV8awix2jc=" [ "10.0.1.18/32" ])
          (makePeer "/dEuzFkp1H1FySX/NwOAI+K3FqEPOZK/CjuRoZQymHI=" [ "10.0.1.19/32" ])
          (makePeer "je1/ZqP5k8SGlzrTjQT6+mWJ/5XveOomikAbNe/5nEQ=" [ "10.0.1.20/32" ])
          (makePeer "MpNvkU3pjJ30r3pmy4jlH5OBlB7IsFvNdYIJTDHNv0E=" [ "10.0.1.21/32" ])
          (makePeer "osossFrXtubHNRXwQaWjEGYE92LhQHBAhawTKSZBhwY=" [ "10.0.1.22/32" ])
          (makePeer "oBzJ+jbeXPgn/PfZ1mJzKqBS6T5Tgzg5XPTU0vvyHSA=" [ "10.0.1.23/32" ])
          (makePeer "tlNmIi8/YOxhYKlj1C/Np2qLXYdS2Fl3gnxPhoHgYQI=" [ "10.0.1.24/32" ])
          (makePeer "u3vC0cCk/Tewx8L4NDAsKt7YAmLqp/5YuzKSr2DBDDI=" [ "10.0.1.25/32" ])
          (makePeer "ZPYYdjejpPBxya6zZsstIwrdOASIPjtsKX4Kh/MmgzI=" [ "10.0.1.26/32" ])
          (makePeer "gkug2F5Jz9enIRX2BdCKajerbRNkCppCE7P+gZU74R4=" [ "10.0.1.27/32" ])
          (makePeer "rxF5WaJ4u5TaXUpxM1B24l8SYY8FOe9Df0jzWTwcJRo=" [ "10.0.1.28/32" ])
          (makePeer "8PoySfifjM8fx9pPTDzr1bPHsrmZQEXAVUVQ0yOisCU=" [ "10.0.1.29/32" ])
          (makePeer "Ie5R/dhbo2XL2FKEy8IXiR/+s19+3GADnA2xY7pJ4RQ=" [ "10.0.1.30/32" ])
          (makePeer "lVzDxAgX+/yQXt/49PKaacxs9z9cTmCtGd1DpKhC9i0=" [ "10.0.1.31/32" ])
          (makePeer "GiMhUPXnCu8V+d3bg9RF7qG9JcMLUppy9yPH/6Gr6zo=" [ "10.0.1.32/32" ])
          (makePeer "luO/YxGwamUltBvaI8FP5phwrjxCD5EV8ElC9FaNSn4=" [ "10.0.1.33/32" ])
          (makePeer "flEgvGvdQBu8CSluOPpai78AiV+nfqMC9KZAzoMbtDw=" [ "10.0.1.34/32" ])
          (makePeer "nx70v5IqLltD60pYsB36RGNG/y7KK2/VgFg/vj+tBDI=" [ "10.0.1.35/32" ])
          (makePeer "ISWSb+SZawyr41q969VdkOBjrig4Bk6dA9ciI6VA7iI=" [ "10.0.1.36/32" ])
          (makePeer "HcZOGKGM+sfUC23r8yMi8RpDN+VyPyr3/nwVs0BZnAs=" [ "10.0.1.37/32" ])
          (makePeer "/FVOLkqOWZ/7GnK/RiZVht3xYbkLLaZY3uvf0r8grE0=" [ "10.0.1.38/32" ])
          (makePeer "ef08SkM6wKX9LoN6qAf0+xGh0VB4sRErIc5EdXi2IXQ=" [ "10.0.1.39/32" ])
          (makePeer "gAwa2DUy1BtQCUYRymiQ1u1VLD551m6QKStJRuSeIAs=" [ "10.0.1.40/32" ])
          (makePeer "uGtKS8SW9+PUkGN+XNyDioAdrTiY2U4cwF87BWF+IQc=" [ "10.0.1.41/32" ])
